...
CREATE TABLE `cart` (
  ...
  CONSTRAINT `fk_cart_menu1` FOREIGN KEY (`menu_id`) REFERENCES `product` (`product_id`)
...
CREATE TABLE `order_detail` (
  ...
  CONSTRAINT `fk_order_item_menu1` FOREIGN KEY (`menu_id`) REFERENCES `product` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-05-18 23:07:15
